...
import (
	...
	"github.com/wyy-go/wencoding/testdata/examplepb"
...
func testBuiltinType[T any](t *testing.T, tests []testStruct[T], checkFunc func(string) (T, error), equal func(any, any) bool) {
...
func testBuiltinTypeSlices[T any](t *testing.T, tests []testStruct[T], checkFunc func(string, string) (T, error), equal func(any, any) bool) {
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			ts, err := checkFunc(tt.input, ",")
			switch {
...
func Test_String(t *testing.T) {
	...
	testBuiltinType(t, tests1, String, reflect.DeepEqual)
	...
	testBuiltinType(t, tests2, StringValue, reflect.DeepEqual)
}
...
func Test_StringSlice(t *testing.T) {
	...
	testBuiltinTypeSlices(t, tests, StringSlice, reflect.DeepEqual)
}
...
func Test_Bool(t *testing.T) {
	...
	testBuiltinType(t, tests, BoolValue, reflect.DeepEqual)
}
...
func Test_BoolSlice(t *testing.T) {
	...
	testBuiltinTypeSlices(t, tests, BoolSlice, reflect.DeepEqual)
}
...
func Test_Float64(t *testing.T) {
	...
	testBuiltinType(t, tests, DoubleValue, reflect.DeepEqual)
}
...
func Test_Float64Slice(t *testing.T) {
	...
	testBuiltinTypeSlices(t, tests, Float64Slice, reflect.DeepEqual)
}
...
func Test_Float32(t *testing.T) {
	...
	testBuiltinType(t, tests, FloatValue, reflect.DeepEqual)
}
...
func Test_Float32Slice(t *testing.T) {
	...
	testBuiltinTypeSlices(t, tests, Float32Slice, reflect.DeepEqual)
}
...
func Test_Int64(t *testing.T) {
	...
	testBuiltinType(t, tests, Int64Value, protoEqual)
}
...
func Test_Int64Slice(t *testing.T) {
	...
	testBuiltinTypeSlices(t, tests, Int64Slice, reflect.DeepEqual)
}
...
func Test_Int32(t *testing.T) {
	...
	testBuiltinType(t, tests, Int32Value, reflect.DeepEqual)
}
...
func Test_Int32Slice(t *testing.T) {
	...
	testBuiltinTypeSlices(t, tests, Int32Slice, reflect.DeepEqual)
}
...
func Test_Uint64(t *testing.T) {
	...
	testBuiltinType(t, tests, UInt64Value, reflect.DeepEqual)
}
...
func Test_Uint64Slice(t *testing.T) {
	...
	testBuiltinTypeSlices(t, tests, Uint64Slice, reflect.DeepEqual)
}
...
func Test_Uint32(t *testing.T) {
	...
	testBuiltinType(t, tests, UInt32Value, reflect.DeepEqual)
}
...
func Test_Uint32Slice(t *testing.T) {
	...
	testBuiltinTypeSlices(t, tests, Uint32Slice, reflect.DeepEqual)
}
...
func Test_Bytes(t *testing.T) {
	...
	testBuiltinType(t, tests, BytesValue, reflect.DeepEqual)
}
...
func Test_BytesSlice(t *testing.T) {
	...
	testBuiltinTypeSlices(t, tests, BytesSlice, reflect.DeepEqual)
}
...
func Test_Timestamp(t *testing.T) {
	...
	testBuiltinType(t, tests, Timestamp, protoEqual)
}
...
func Test_Duration(t *testing.T) {
	...
	testBuiltinType(t, tests, Duration, protoEqual)
}
